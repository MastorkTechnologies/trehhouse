      ...
      {isMobile ? (
          ...
          <section id='hero'>
            <div className='row'>
              <div className='heroleftm'>
                ...
                <p>
                  At Trēhouse, we redefine business development through
                  innovative collaboration. Our unique approach eliminates
                  upfront costs, enabling us to analyze your business and unlock
                  untapped revenue streams, territories, and opportunities, all
                  while sharing in the success we help create.
                </p>
                <div className='row'>
                  <div>
                ...
                <div className='row ticks'>
                  <p>
                    <img
                      src='./images/tick.png'
                      style={{ width: "clamp(0.8rem, 2.2vw, 1.4rem)" }}
                    />{" "}
                    &nbsp; Free Register
                  </p>
                  <p>
            ...
            <div className='button-overlay'>
              ...
              >
                ...
                <p style={{ textAlign: "justify" }}>
                  ...
                  relationships. Backed by extensive expertise in organizational
                  operations, sales, and development, TRĒhouse is your strategic
              ...
              >
                ...
                <p style={{ textAlign: "justify" }}>
                  We engage in thorough discovery, either over a call or in
                  person, to understand our potential partners' businesses.
                </p>
              </motion.div>
              <motion.div
                variants={{
              ...
              >
                ...
                <p style={{ textAlign: "justify" }}>
                  We pinpoint growth opportunities and tailor a partnership
              ...
              >
                ...
                <p style={{ textAlign: "justify" }}>
                  We work closely with partners, ensuring our success is
                  directly tied to theirs through our shared revenue model.
                </p>
              </motion.div>
            </div>
          </section>
            ...
            <div className='button-overlay'>
              ...
              >
                ...
                <p>
                  ...
                  signifies a commitment to your growth. Leave the risk to us
              ...
              <div id='Hww' className='absdivm'>
                ...
                <div className='dc-containerm'>
                  ...
                  >
                    ...
                    <p style={{ color: "#9794A6", fontSize: "12px" }}>
                      Crafting tailored strategies rooted in deep industry
                  ...
                  >
                    ...
                    <p style={{ color: "#9794A6", fontSize: "12px" }}>
                      Partnering for mutual growth, where your success is our
                      triumph.
                    </p>
                    {/* <p style={{color:"#01966B", fontSize:"18px"}}>Read More <LiaLongArrowAltRightSolid style={{position:'relative', top:"3px"}} /></p> */}
                  </motion.div>
                  ...
                  >
                    ...
                    <p style={{ color: "#9794A6", fontSize: "12px" }}>
                      Unleashing creativity through dynamic partnerships for
            ...
            >
              ...
              <div className='sec4textm'>
                ...
                <div className='row'>
                  <p>
                    {" "}
                    <img src='./images/ptm1.png' width={"80%"} />
                  </p>
                ...
                <div className='row'>
                  <p>
                    {" "}
                    <img src='./images/ptm2.png' width={"80%"} />
                  </p>
                  <p>Shared Success</p>
                </div>
                <div className='row'>
                  <p>
                    {" "}
                    <img src='./images/ptm3.png' width={"80%"} />
                  </p>
        ...
        <div className='button-overlay' style={{marginTop:"10%", paddingTop:"20%"}}>
          ...
          <section id='contact' style={{ overflow: "hidden" }}>
            <div
              className='button-overlay'
              style={{ marginTop: "10%", marginBottom: "0px" }}
            >
              ...
              >
                ...
                >
                  ...
                  >
                    Unlock Your Potential with Trēhouse
                  </h2>
                  <p
                    style={{
                      fontSize: "14px",
                  ...
                  >
                    Discover how our expertise-driven solutions can elevate your
                    business. Book a call now to explore innovative
          ...
          >
              ...
              <li>
                <ul className='nestedList2'>
                  <li className='flistItemm'>
                    <p>About</p>
                    <p>
                      <a className='aw' href='#ourmodel'>
                        Our Model
                      </a>
                    </p>
                    <p>
                      <a className='aw' href='#Hww'>
                        How we work
                      </a>
                    </p>
                    {/* <p><a className='aw' href='#testimonials'>Testimonials</a></p> */}
                    <p>
                      <a className='aw' href='#contact'>
                        Contact Us
                      </a>
                    </p>
                  </li>
            ...
            <p
              style={{ color: "white", marginBottom: "20px", fontSize: "12px" }}
            >
              ...
              <div className='heroleft'>
                ...
                <div className='row ticks'>
                  <p>
                    <img
                      src='./images/tick.png'
                      style={{ width: "clamp(0.5rem, 1.2vw, 1rem)" }}
                    />{" "}
                    &nbsp; Free Register
                  </p>
                  <p>
              ...
              <div className='absdiv '>
                ...
                <div className='row dc-container'>
                  ...
                  >
                    ...
                    <p style={{ color: "#9794A6", marginBottom: "30px" }}>
                      Partnering for mutual growth, where your success is our
                      triumph.
                    </p>
                    {/* <p style={{color:"#01966B", fontSize:"18px"}}>Read More <LiaLongArrowAltRightSolid style={{position:'relative', top:"3px"}} /></p> */}
        ...
        <div className='button-overlay' style={{marginTop:"2%"}}>
          ...
          <section id='contact' style={{ overflow: "hidden" }}>
            <div
              className='button-overlay'
              style={{ marginTop: "4%", marginBottom: "0px" }}
            >
              ...
              >
                <div style={{ padding: "3vw", width: "50%" }}>
                  ...
                  <h2 style={{ fontSize: "43px", margin: "0px" }}>
                    Unlock Your Potential with Trēhouse
                  </h2>
